    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Company Info */}
          <div>
            <h3 className="text-white text-xl font-bold mb-4">UnifiedCare</h3>
            <p className="text-sm leading-relaxed">
              Connecting families with trusted caregivers for quality in-home care services.
            </p>
          </div>

          {/* For Families */}
          <div>
            <h4 className="text-white font-semibold mb-4">For Families</h4>
          ...
          {/* For Caregivers */}
          <div>
            <h4 className="text-white font-semibold mb-4">For Caregivers</h4>
            <ul className="space-y-2 text-sm">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">© 2026 UnifiedCare. All rights reserved.</p>
